  ...
  "google-ai-studio": {
    ...
    models: [
      ...
      },
      {
        ...
        name: "Imagen 4",
        description: "Google Imagen 4 Standard ~$0.04/img",
        capabilities: { textToImage: true, imageToImage: false },
      },
      {
        id: "imagen-4.0-fast-generate-001",
        name: "Imagen 4 Fast",
        description: "Schnelle Imagen 4 Variante ~$0.02/img",
        capabilities: { textToImage: true, imageToImage: false },
      },
    ],
  },
  ...
  fal: {
    ...
    models: [
      ...
      },
      {
        ...
        description: "Bis 2K Auflösung, höchste Qualität",
        capabilities: { textToImage: true, imageToImage: false },
      },
      {
      ...
      },
      {
        ...
        description: "Bestes Image Editing",
        capabilities: { textToImage: true, imageToImage: true },
      },
      {
        id: "fal-ai/ideogram/v3",
        name: "Ideogram V3",
        description: "Bester Text-in-Bild ~$0.08/img",
        capabilities: { textToImage: true, imageToImage: false },
      },
      {
